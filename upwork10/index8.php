...
<body>
  <div class="container" >
    ...
    <form class="container d-flex justify-content-center p-5"  action="" method="POST">
     ...
     <br>
     <div >
        <label  onclick="myFunction()" class="dropbtn form-control" style="text-align: center;" readonly><i class="fa-solid fa-star"></i>&nbsp Star Rating</a></label>
