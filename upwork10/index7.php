...
<body>
  <div class="container" >
    ...
    <form class="container d-flex justify-content-center p-5"  action="" method="POST">
     ...
     <br>
     <div >
        <label  onclick="myFunction()" class="dropbtn form-control" style="text-align: center;" readonly><i class="fa-solid fa-signal"></i>&nbsp Option Scale</a></label>
      ...
      if (openDropdown.classList.contains('show')) {
        ...
        <div class="form-row">
            ...
            <div class="form-group col-md-4">
              ...
              <label >From</label>
              <input type="email" class="form-control" id="inputEmail4" placeholder="0">
            </div>
        ...
        <div class="form-row">
            ...
            <div class="form-group col-md-4">
              ...
              <input type="email" class="form-control" id="inputEmail4" placeholder="Example">
            </div>
            <div class="form-group col-md-4">
